...
export const metadata: Metadata = {
  ...
  title: {
    default: "Snip — Free URL Shortener with Analytics, QR Codes & API",
    template: "%s — Snip URL Shortener",
  },
  description:
  ...
  authors: [{ name: "Snip", url: "https://snipurl.click" }],
  creator: "Snip",
  publisher: "Snip",
  category: "Technology",
  openGraph: {
    ...
    url: "/",
    siteName: "Snip",
    title: "Snip — Free URL Shortener with Analytics, QR Codes & API",
    description:
      "The open-source URL shortener. Custom aliases, QR codes, click analytics, password protection, and a full REST API. Free forever.",
    images: [
      {
        url: "/og.png",
        width: 1200,
        height: 630,
        alt: "Snip — Free URL Shortener with Analytics, QR Codes & Developer API",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "Snip — Free URL Shortener with Analytics, QR Codes & API",
    description:
      "The open-source URL shortener. Custom aliases, QR codes, click analytics, and a full REST API. Free forever.",
    images: ["/og.png"],
  },
  icons: {
    icon: [
